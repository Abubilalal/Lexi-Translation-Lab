        ...
        <Reveal>
          <div className="overflow-hidden rounded-3xl bg-surface shadow-[var(--shadow-lift)] ring-1 ring-border">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="bg-mesh p-10 sm:p-14">
                <p className="micro-label mb-4">Begin your matter</p>
              ...
              <div className="flex flex-col items-center justify-center gap-6 p-10 sm:p-14">
                <div className="text-center">
                  <h3 className="text-2xl font-semibold text-foreground">
                    Chat with us on WhatsApp
                  </h3>
                  <p className="mt-3 text-base text-ink-muted">
                    Send us your documents and get a binding quote in 15 minutes — available 24/7.
                  </p>
                </div>
                <a
                  href="https://wa.me/918368699442?text=Hi,%20I%20am%20contacting%20through%20lexilab.in."
